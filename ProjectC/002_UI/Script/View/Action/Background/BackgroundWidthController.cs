...
public class BackgroundWidthController : MonoBehaviour, ISerializationCallbackReceiver
{
    ...
    {
        void DevBuildLogError(string message)
        {
        ...
        if (m_left == null)
        {
            DevBuildLogError("左側のRectTransformが設定されていません");
            isNull = true;
        }
        if (m_leftImage == null)
        {
            DevBuildLogError("左側のImageが設定されていません");
            isNull = true;
        }

        if (m_mid == null)
        {
            DevBuildLogError("真ん中のRectTransformが設定されていません");
            isNull = true;
        }

        if (m_right == null)
        {
            DevBuildLogError("右側のRectTransformが設定されていません");
            isNull = true;
        }
        if (m_rightImage == null)
        {
            DevBuildLogError("右側のImageが設定されていません");
            isNull = true;
        }
