...
public class SelectTutorialController : MonoBehaviour
{
    ...
    [Header("次に進むボタン")]
    [SerializeField]
    private TutorialInputActiomButton m_nextInputActionButton = null;

    [BoxGroup("Button")]
    [Header("前に戻るボタン")]
    [SerializeField]
    private TutorialInputActiomButton m_backInputActionButton = null;

    [BoxGroup("Button")]
    [Header("終了ボタン")]
    [SerializeField]
    private TutorialInputActiomButton m_closeInputActionButton = null;
    ...
    public bool IsClose()
    {
        if (m_closeInputActionButton == null) return false;
