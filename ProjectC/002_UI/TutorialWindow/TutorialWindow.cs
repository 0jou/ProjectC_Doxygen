...
public class TutorialWindow : BaseWindow
{
    ...
    [Header("チュートリアル説明文")]
    [SerializeField]
    private ChangeTutorialDescription m_changeTutorialDescription = null;
    ...
    virtual protected bool IsCloseTutorial()
    {
        #region nullチェック
        if (m_selectTutorialController == null)
        {
        ...
        return m_selectTutorialController.IsClose();
    }
