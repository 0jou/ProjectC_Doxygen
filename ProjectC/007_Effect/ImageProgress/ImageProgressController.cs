...
public class ImageProgressController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        m_image.material.SetFloat("Progress", m_progress);
        m_image.material.SetTexture("MainTex", m_textures[0]);
    }
    ...
    public void SetProgress(float newProgress)
    {
        ...
        {
            m_image.material.SetTexture("MainTex", m_textures[imageIndex]);
        }
        m_image.material.SetFloat("Progress", m_progress);
    }
